...
namespace YooAsset.Editor
{
    public class AssetBundleBuilderWindow : EditorWindow
    {
        ...
        /// <summary>
        /// 保存不同构建管线，键为EBuildPipeline下枚举项的ToString，值为对应BuildPipelineViewerBase子类的Type
        /// </summary>
        ...
        public void CreateGUI()
        {
            try
            {
                // EditorWindow.rootVisualElement，代表该窗口的可视树根容器，但它不是“窗口对象本身”，而是窗口的 UI 根节点。
