...
{
    /// <summary>
    /// *我觉得这个是AB构建的统一入口，将构建参数封装成构建参数文本，同时保存在构建上下文
    /// </summary>
    public class AssetBundleBuilder
    {
        /// <summary>
        /// *保存IContentObject
        /// AssetBundleBuilder.cs 保存 BuildParametersContext(BuildParameter)
        /// TaskGetBuildMap.cs 保存 BuildMapContext
        /// TaskBuild.cs 保存 BuildResultContext(IBundleBuildResults)
        /// </summary>
